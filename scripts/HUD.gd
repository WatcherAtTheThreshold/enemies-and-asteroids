...
func _ready() -> void:
	...
	if base:
		...
		$Screen/BaseHP/HPText.text = "%d/%d" % [base_hp.current_hp, base_hp.max_hp]
	...
	if player:
		...
		$Screen/PlayerHP/HPText.text = "%d/%d" % [player_hp.current_hp, player_hp.max_hp]
...
func _on_base_health_changed(current_hp: int, max_hp: int) -> void:
	...
	$Screen/BaseHP/HPText.text = "%d/%d" % [current_hp, max_hp]
...
func _on_player_health_changed(current_hp: int, max_hp: int) -> void:
	...
	$Screen/PlayerHP/HPText.text = "%d/%d" % [current_hp, max_hp]
